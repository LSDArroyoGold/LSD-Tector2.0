...
if AUTO_SYNC == 'ON':
	duracion_h = '$(awk -F' = ' '/duracion_amanecer_sync/{print $2}' /home/lsd/config_horarios.txt | tr -d ' \r')'
else:
	from datetime import datetime
	t_inicio = datetime.strptime('$(awk -F' = ' '/inicio_amanecer/{print $2}' /home/lsd/config_horarios.txt | tr -d ' \r')', '%H:%M')
	t_fin = datetime.strptime('$(awk -F' = ' '/fin_amanecer/{print $2}' /home/lsd/config_horarios.txt | tr -d ' \r')', '%H:%M')
